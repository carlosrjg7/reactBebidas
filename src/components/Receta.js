...
const Receta = ({receta}) => {
    ...
    //configuraciuon de modal de material-ui
    ...
    const mostrarIngredientes = detalles => {
        ...
        for( let i = 1; i<16; i++){
            if(detalles[`strIngredient${i}`]){
                ingredientes.push(
                   <li key={i}>{detalles[`strIngredient${i}`]} {detalles[`strMeasure${i}`]}</li> 
                    )
            }
        }
            ...
            <div className="card-body">
                ...
                >
                    ...
                    >
                        ...
                        <img className="img-fluid my-4" src={detalles.strDrinkThumb} alt={detalles.strDrink} />
